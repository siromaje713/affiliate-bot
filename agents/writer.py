...
最終文: 自分の体験+保存誘導 or 姉への称賛（例：「20代の私も真似したら〜」「姉の言う通りだった」「保存して試してみて」）
...
・乳液で蓋をしてから保湿クリーム
・週2でビタミンCの美容液
20代のうちからやっておけって言われた。保存して真似してみて
...
・寝る前にビタミンCのサプリ
正直スキンケアより食事変えた方が肌荒れ減った。姉の言う通りだった
...
・眉毛は描くより「整える」が先
・チークは笑った頬の高い位置にだけ
引き算メイクにしたら「肌きれいになった？」って言われた。足してたのが間違いだった
...
・寝る前のカフェインは14時まで
・休みの日も起きる時間は同じにする
これやったら肌荒れ減ったし朝の顔のむくみなくなった。睡眠が最強の美容液だった
...
ストレスでフェイスラインにニキビ出てたの全部消えた。肌のケアよりメンタルのケアだった

【絶対ルール】
- 必ず「姉」起点（姉が〜 / 姉に〜 / 姉から〜）で始める
- 箇条書きは必ず4項目（3項目も5項目もNG）
- 締めの1文は自分(20代の私)の体験 or 姉への称賛で終わる
