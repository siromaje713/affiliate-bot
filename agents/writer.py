...
"""
    ...
    if post_type == "engage":
        ...
        prompt = f"""Threadsで返信往復を最大化する有益情報×煽り口調の短文投稿を3パターン生成してください。
...
【文字数ルール（パターン別に厳守）】
- パターン1：25〜45文字（超短文・刺しにいく）
- パターン2〜3：50〜80文字

【3パターン構成（A/B/C の3型を1つずつ使う・D/E/Fは割愛）】
...
【絶対条件】
- 型A・型B・型Cの順で1つずつ、計3パターン生成
- 型A は25〜45字、型B・型C は50〜80字
